...
class Pppoe(object):
    def __init__(self):
        ...
        builder.connect_signals({"gtk_main_quit": self.quit_pppoe,
                                 ...
                                 "on_button_disconnect_clicked":
                                     self.disconnect,
                                 "on_entry_password_sudo_activate":
                                     self.connect})
        ...
        #    if 'mate-session' in session:
        #        bus.add_match_string(
        #            "type='signal',interface='org.gnome.ScreenSaver'")
        #    elif 'gnome-session' in session:
        #        bus.add_match_string(
    ...
    def disconnect(self, widget):
        ...
        self.status.gtk.Image.from_icon_name("network-idle",
                                             Gtk.IconSize.BUTTON)
